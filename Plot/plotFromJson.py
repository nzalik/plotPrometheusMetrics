...
json_files = [
              ...
              # './memory/container_memory_max_usage_bytes_li1_teaui.json',
               '../data/cpu/teastore-recommender-6b67599fb9-gsr8s.json',
               '../data/cpu/teastore-persistence-7d6bcb6b96-ltlf8.json',
               '../data/cpu/teastore-webui-59f448d7f5-kvj5z.json',
               '../data/cpu/teastore-registry-69c86867cd-qrd98.json',
               '../data/cpu/teastore-image-6b9796d7c7-pqvvq.json',
               '../data/cpu/teastore-db-7685d7b587-xc96b.json',
               '../data/cpu/teastore-auth-8877cbcc9-287j7.json',
              ]
